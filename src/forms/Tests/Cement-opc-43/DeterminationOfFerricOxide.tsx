...
const DeterminationOfFerricOxide = () => {
    ...
    return (
        ...
        >
            <h3 style={{ textAlign: 'center', marginBottom: '20px', fontWeight: 'bold' }}>Determination of Ferric Oxide</h3>

            {renderInput("Molarity of EDTA (M)", "input1", m, setM)}
            {renderInput("Volume of EDTA consumed for sample (V)", "input2", v, setV)}
            {renderInput("Weight of Sample (W)", "input3", w, setW)}
            ...
            <div style={{ marginTop: '20px', fontWeight: 'bold' }}>
                <p>Fe2O3 % = (V * 79.25 * M * 250 * 100) / (W * 1000 * 25)</p>
                <p>
                    Fe2O3 % = {((v * 79.25 * m * 250 * 100) / (w * 1000 * 25)).toFixed(2)}
                </p>
            </div>
        </form>
    );
...
export default DeterminationOfFerricOxide;
