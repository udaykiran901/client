...
const DeterminationOfInsolubleResidue = () => {
    ...
    return (
        ...
        >
            <h3 style={{ textAlign: 'center', marginBottom: '20px', fontWeight: 'bold' }}>Determination of Insoluble Residue</h3>

            {renderInput("Weight of Sample (W)", "input1", w, setW)}
            {renderInput("Weight of Empty Crucible (W1)", "input2", w1, setW1)}
            {renderInput("Weight of Crucible + Insoluble (W2)", "input3", w2, setW2)}
...
export default DeterminationOfInsolubleResidue;
