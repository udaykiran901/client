...
const CWNaOH = () => {
    ...
    const handleOnSubmittingTest = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        const resultObj = { v1 };
        const updatedBenchRecord = [{ NaOH_Test: { v1 } }];
        const updatedReportValues = [{ NaOH_Test: resultObj }];
        const data = { updatedBenchRecord, jobId, updatedReportValues };
    ...
    return (
        ...
        >
            <h3 style={{ textAlign: 'center', marginBottom: '20px', fontWeight: 'bold' }}>NaOH Test Calculation</h3>

            {renderInput("Volume of NaOH", "input1", v1, setV1)}
