...
const CWPh = () => {
    ...
    return (
        ...
        >
            <h3 style={{ textAlign: 'center', marginBottom: '20px', fontWeight: 'bold' }}>pH Test Submission</h3>

            {renderInput("pH value at 25°C", "input1", ph, setPh)}
