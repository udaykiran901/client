...
const DWMagnesium = () => {
    ...
    return (
        ...
        >
            <h3 style={{ textAlign: 'center', marginBottom: '20px', fontWeight: 'bold' }}>Magnesium Calculation</h3>

            {renderInput("V1 (Vol of EDTA consumed for Total Hardness)", "input1", v1, setV1)}
            {renderInput("V2 (Vol of EDTA consumed for Calcium)", "input2", v2, setV2)}
            {renderInput("Morality (M)", "inputm", m, setM)}
            {renderInput("Volume of Sample (Vs)", "inputvs", vs, setVs)}
