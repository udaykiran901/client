...
const DeterminationOfCaoAndMgoFa: React.FC = () => {
            ...
            if (job && job.bench_record) {
                ...
                const getRes = async () => {
                    try {
                        ...
                        // Ensure mg and resultObj exist before destructuring
                        if (benchRec[0].mg && benchRec[0].mg.resultObj) {
                            const { w, w1, w2 } = benchRec[0].mg.resultObj;
    ...
    return (
        ...
        >
            ...
            {renderInput("Weight of crucible + Ppt (w2)", "input3", w2, setW2, review)}

            <div style={{ marginTop: '20px', fontWeight: 'bold' }}>
                <p>CaO % = (((w2 - w1) * 100) / (w))</p>
                <p>CaO % = {(((w2 - w1) * 100) / w).toFixed(2)}</p>
...
export default DeterminationOfCaoAndMgoFa;
