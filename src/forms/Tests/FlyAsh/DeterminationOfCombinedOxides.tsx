...
const DeterminationOfCombinedOxides: React.FC = () => {
            ...
            if (job && job.bench_record) {
                ...
                const getRes = async () => {
                    try {
                        ...
                        // Ensure combinedOxides and resultObj exist before destructuring
                        if (benchRec[0].combinedOxides && benchRec[0].combinedOxides.resultObj) {
                            const { w, w1, w2 } = benchRec[0].combinedOxides.resultObj;
    ...
    return (
        ...
        >
            <h3 style={{ textAlign: 'center', marginBottom: '20px', fontWeight: 'bold' }}>Determination of Combined Oxides</h3>

            {renderInput("Weight of Sample (w)", "input1", w, setw, review)}
            {renderInput("Weight of empty Crucible (w1)", "input2", w1, setW1, review)}
            {renderInput("Weight of crucible + R₂O₃ (w2)", "input3", w2, setW2, review)}

            <div style={{ marginTop: '20px', fontWeight: 'bold' }}>
                <p>Combined Oxides % = (((w2 - w1) / w) * (100))</p>
                <p>Combined Oxides % = {(((w2 - w1) / w) * 100).toFixed(2)}</p>
            </div>
...
export default DeterminationOfCombinedOxides;
