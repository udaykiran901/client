...
const MnO = () => {
    ...
    // Fetch single job details when the component mounts
    useEffect(() => {
    ...
    const handleOnSubmittingTest = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        const MnO = val; // Calculation remains the same

        const updatedBenchRecord = [{ MnO: { val } }];
        const updatedReportValues = [{ MnO: { MnO } }];
    ...
    return (
        ...
        >
            <h3 style={{ textAlign: 'center', marginBottom: '20px', fontWeight: 'bold' }}>MnO Calculation</h3>

            {renderInput("MnO", "input1", val, setVal)}
