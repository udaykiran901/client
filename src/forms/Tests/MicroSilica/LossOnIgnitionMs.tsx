...
const LossOnIgnitionMs = () => {
            ...
            if (job && job.bench_record) {
                ...
                const getRes = async () => {
                    try {
                        ...
                        // Ensure LossOnIgnition exists and has required properties before destructuring
                        if (benchRec[0].LossOnIgnition) {
                            const { w1, w2, w3 } = benchRec[0].LossOnIgnition;
    ...
    const handleOnSubmittingTest = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        const updatedBenchRecord = [{ LossOnIgnition: { w1, w2, w3 } }];
        const updatedReportValues = [{ LossOnIgnition: { LOI } }];
    ...
    return (
        ...
        >
            <h3 style={{ textAlign: 'center', marginBottom: '20px', fontWeight: 'bold' }}>Loss on Ignition Calculation</h3>
            ...
            <div style={{ marginTop: '20px', fontWeight: 'bold' }}>
                ...
                <p>
                    Loss on Ignition % = ((({w2} - {w3}) * 100) / ({w2} - {w1}))
                </p>
...
export default LossOnIgnitionMs;
